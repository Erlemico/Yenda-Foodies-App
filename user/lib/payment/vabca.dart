...
class VaBca extends StatefulWidget {
  final PaymentMethod selectedMethod;
  final String totalPayment;

  VaBca({Key? key, required this.selectedMethod, required this.totalPayment}) : super(key: key);

  @override
  _VaBcaState createState() => _VaBcaState();
}

class _VaBcaState extends State<VaBca> {
  late String orderId;
  ...
  void generateOrderId() {
    ...
    setState(() {
      orderId = '$date$randomDigits$randomAlphabets';
    });
  }

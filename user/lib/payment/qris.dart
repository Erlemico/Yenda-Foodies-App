...
class Qris extends StatefulWidget {
  ...
  Qris({Key? key, required this.selectedMethod, required this.totalPayment}) : super(key: key);
          ...
          children: [
            ...
            Center(
              child: Container(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/images/payments/other/qrcode.png',
                  ),
                ),
              ),
            ),
            ...
            Center(
              child: Text(
                'Pindai QR Code di atas untuk melakukan pembayaran',
                style: TextStyle(
                  fontSize: 12.0,
                  color: Colors.black,
                  fontFamily: 'Inter',
